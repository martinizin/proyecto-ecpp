"""
Vistas del bounded context de reportes (HU26 + HU27 + HU27b).

HU26: generación, listado, descarga y verificación de hash de los
reportes normativos ANT (Resolución 005-DIR-2022).
