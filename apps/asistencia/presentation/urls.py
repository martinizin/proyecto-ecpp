...
from .views import (
    ...
    DetalleCalificacionesEstudianteView,
...
urlpatterns = [
    ...
    path(
        "supervision/estudiante/<int:estudiante_id>/detalle-calificaciones/",
        DetalleCalificacionesEstudianteView.as_view(),
        name="supervision_detalle_calificaciones",
    ),
]
